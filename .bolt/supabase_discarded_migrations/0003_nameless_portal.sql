/*
  ...
  1. New Tables
    - api_keys: Store API keys for merchants
    - team_invitations: Track pending team invites
    - billing_details: Store billing information
    - security_settings: Store security configurations
